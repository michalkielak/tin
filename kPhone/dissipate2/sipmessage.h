...
public:
	 ...
	 * get the SipIfMatch
	*/
	QString getSipIfMatch(void) { return SipETag;}
	...
	*/
	...
	/**
	 * get the Min-Expires-Time
	*/
	QString getMinExpires(void) { return minExpires;}
private:
	SipViaList vialist;
...
/**
*	parse the start line on a message
*/
	void parseStartLine( QString startline );
/**
*	parse all headers in that message
*/
