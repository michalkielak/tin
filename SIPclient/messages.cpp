...
string Messages::getRegisterAuthMsg(string nonce, string response)
{
...
string Messages::getAckMsg(string toTag)
{	
...
string Messages::getByeMsg(string toTag)
{
...
string Messages::getOkMsg(string via, string from, string to, string call_id, string c_seq)
{
	ok="SIP/2.0 200 OK\r\n";
	ok+="Via: "+via+"\r\n";
	ok+="From: "+from+"\r\n";
